...
const page = combinationPages['graphic-design-asia']
const jobTypeConfig = jobTypePages['graphic-design']
const regionConfig = regionalPages['asia']
const pageUrl = `${BASE_URL}/remote-graphic-design-jobs-asia`
...
export default async function Page() {
  ...
  const regionName = 'asia' === 'worldwide' ? 'Worldwide' : regionConfig.h1.replace('Remote Design Jobs in ', '')
