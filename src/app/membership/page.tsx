        ...
        <div className="max-w-3xl mx-auto">
          ...
          {fromAlerts && (
            <div className="mt-6 p-4 bg-violet-50 border border-violet-200 rounded-xl flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-violet-900">Your job alert preferences are saved!</p>
                <p className="text-sm text-violet-700 mt-0.5">Complete your membership to activate daily personalized job alerts.</p>
              </div>
            </div>
          )}
