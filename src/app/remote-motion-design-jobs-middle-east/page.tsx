...
const page = combinationPages['motion-design-middle-east']
const jobTypeConfig = jobTypePages['motion-design']
const regionConfig = regionalPages['middle-east']
const pageUrl = `${BASE_URL}/remote-motion-design-jobs-middle-east`
...
export default async function Page() {
  ...
  return (
    <SEOLandingPage
      ...
      parentPage={{ label: `${jobTypeName} Jobs`, href: `/remote-motion-design-jobs` }}
    />
  )
}
