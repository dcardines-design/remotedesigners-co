...
const page = combinationPages['graphic-design-middle-east']
const jobTypeConfig = jobTypePages['graphic-design']
const regionConfig = regionalPages['middle-east']
const pageUrl = `${BASE_URL}/remote-graphic-design-jobs-middle-east`
...
export default async function Page() {
  ...
  const regionName = 'middle-east' === 'worldwide' ? 'Worldwide' : regionConfig.h1.replace('Remote Design Jobs in ', '')
  ...
  return (
    <SEOLandingPage
      ...
      parentPage={{ label: `${jobTypeName} Jobs`, href: `/remote-graphic-design-jobs` }}
    />
  )
}
