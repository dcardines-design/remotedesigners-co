...
const page = jobTypePages['interaction-design']
const pageUrl = `${BASE_URL}/remote-interaction-design-jobs`
  ...
  return (
    <>
      ...
      <SEOLandingPage
        ...
        jobs={jobs || []}
        totalCount={count || 0}
        currentSlug="interaction-design"
        pageType="jobType"
        faqs={page.faqs}
        breadcrumbLabel="Interaction Design"
      />
    </>
  )
}
