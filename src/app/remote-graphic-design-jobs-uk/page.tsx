...
const page = combinationPages['graphic-design-uk']
const jobTypeConfig = jobTypePages['graphic-design']
const regionConfig = regionalPages['uk']
const pageUrl = `${BASE_URL}/remote-graphic-design-jobs-uk`
...
export default async function Page() {
  ...
  const regionName = regionConfig.breadcrumbName || regionConfig.h1.replace('Remote Design Jobs in ', '')
