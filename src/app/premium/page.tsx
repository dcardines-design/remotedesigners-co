    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="pt-12 pb-20 px-4 relative">
        <div className="max-w-2xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full text-sm mb-6 bg-violet-600 shadow-[0px_4px_0px_0px_#5b21b6,0px_8px_20px_-4px_rgba(139,92,246,0.5)]">
