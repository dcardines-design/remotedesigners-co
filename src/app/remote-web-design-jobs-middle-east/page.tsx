...
const page = combinationPages['web-design-middle-east']
const jobTypeConfig = jobTypePages['web-design']
const regionConfig = regionalPages['middle-east']
const pageUrl = `${BASE_URL}/remote-web-design-jobs-middle-east`
...
export default async function Page() {
  ...
  return (
    <SEOLandingPage
      ...
      parentPage={{ label: `${jobTypeName} Jobs`, href: `/remote-web-design-jobs` }}
    />
  )
}
