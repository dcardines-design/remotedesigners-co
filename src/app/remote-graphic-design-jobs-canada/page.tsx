...
const page = combinationPages['graphic-design-canada']
const jobTypeConfig = jobTypePages['graphic-design']
const regionConfig = regionalPages['canada']
const pageUrl = `${BASE_URL}/remote-graphic-design-jobs-canada`
...
export default async function Page() {
  ...
  const regionName = 'canada' === 'worldwide' ? 'Worldwide' : regionConfig.h1.replace('Remote Design Jobs in ', '')
