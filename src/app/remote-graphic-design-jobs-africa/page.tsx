...
const page = combinationPages['graphic-design-africa']
const jobTypeConfig = jobTypePages['graphic-design']
const regionConfig = regionalPages['africa']
const pageUrl = `${BASE_URL}/remote-graphic-design-jobs-africa`
...
export default async function Page() {
  ...
  const regionName = 'africa' === 'worldwide' ? 'Worldwide' : regionConfig.h1.replace('Remote Design Jobs in ', '')
