      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 pt-16 pb-4 md:pb-16">
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1 space-y-4">
            ...
            <Link href="/resume-builder" onClick={() => trackEvent.resumeBuilderPromoClick()} className="block border border-neutral-200 rounded-xl px-5 py-7 hover:border-neutral-300 hover:shadow-[0px_4px_0px_0px_rgba(0,0,0,0.08),0px_1px_2px_0px_rgba(0,0,0,0.05)] transition-all duration-200 relative overflow-hidden group" style={{ background: 'linear-gradient(135deg, #fafafa 0%, #ffffff 40%, #fafbff 70%, #faf9ff 100%)' }}>
