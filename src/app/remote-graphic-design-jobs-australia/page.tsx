...
const page = combinationPages['graphic-design-australia']
const jobTypeConfig = jobTypePages['graphic-design']
const regionConfig = regionalPages['australia']
const pageUrl = `${BASE_URL}/remote-graphic-design-jobs-australia`
...
export default async function Page() {
  ...
  const regionName = 'australia' === 'worldwide' ? 'Worldwide' : regionConfig.h1.replace('Remote Design Jobs in ', '')
