...
const page = experienceLevelPages['mid-level-designer']
const pageUrl = `${BASE_URL}/mid-level-designer-jobs`
  ...
  return (
    <>
      ...
      <SEOLandingPage
        ...
        jobs={jobs || []}
        totalCount={count || 0}
        currentSlug="mid-level-designer"
        pageType="experienceLevel"
        faqs={allFaqs}
        breadcrumbLabel="Mid-Level"
      />
    </>
  )
}
