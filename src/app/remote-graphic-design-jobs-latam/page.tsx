...
const page = combinationPages['graphic-design-latam']
const jobTypeConfig = jobTypePages['graphic-design']
const regionConfig = regionalPages['latam']
const pageUrl = `${BASE_URL}/remote-graphic-design-jobs-latam`
...
export default async function Page() {
  ...
  const regionName = 'latam' === 'worldwide' ? 'Worldwide' : regionConfig.h1.replace('Remote Design Jobs in ', '')
