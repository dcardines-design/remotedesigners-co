...
const page = combinationPages['ui-ux-design-middle-east']
const jobTypeConfig = jobTypePages['ui-ux-design']
const regionConfig = regionalPages['middle-east']
const pageUrl = `${BASE_URL}/remote-ui-ux-design-jobs-middle-east`
...
export default async function Page() {
  ...
  return (
    <SEOLandingPage
      ...
      parentPage={{ label: `${jobTypeName} Jobs`, href: `/remote-ui-ux-design-jobs` }}
    />
  )
}
