...
const page = combinationPages['graphic-design-europe']
const jobTypeConfig = jobTypePages['graphic-design']
const regionConfig = regionalPages['europe']
const pageUrl = `${BASE_URL}/remote-graphic-design-jobs-europe`
...
export default async function Page() {
  ...
  const regionName = 'europe' === 'worldwide' ? 'Worldwide' : regionConfig.h1.replace('Remote Design Jobs in ', '')
